...
if (!function_exists('cocobasic_theme_setup')) {
    ...
    function cocobasic_theme_setup() {
        ...
        load_theme_textdomain('ukko-wp', $lang_dir);
...
if (!function_exists('cocobasic_google_fonts_url')) {
    ...
    function cocobasic_google_fonts_url() {
        ...
        if ('off' !== _x('on', 'Google font: on or off', 'ukko-wp')) {
            $font_url = add_query_arg('family', urlencode('Poppins:200,400,500,600,700,800,900'), "//fonts.googleapis.com/css");
        }
        return $font_url;
    }
...
if (!function_exists('cocobasic_load_scripts_and_style')) {
    ...
    function cocobasic_load_scripts_and_style() {
        ...
        wp_enqueue_style('ukko-google-fonts', cocobasic_google_fonts_url(), array(), '1.0.0');
...
//register and load styles which is used on every pages       
        wp_enqueue_style('ukko-clear-style', $base_theme_url . '/css/clear.css');
        wp_enqueue_style('ukko-common-style', $base_theme_url . '/css/common.css');
        wp_enqueue_style('sm-cleen', $base_theme_url . '/css/sm-clean.css');
        wp_enqueue_style('ukko-main-theme-style', $base_theme_url . '/style.css');
...
//JavaScript
        ...
        wp_enqueue_script('ukko-main', $base_theme_url . '/js/main.js', array('jquery'), false, true);
        ...
        wp_localize_script('ukko-main', 'ajax_var', array(
        ...
        wp_add_inline_style('ukko-main', $inlineHeaderCss->cocobasic_theme_customized_style());
    }
...
if (!function_exists('cocobasic_search_form')) {
	...
	<label>		
	<input autocomplete="off" type="search" class="search-field" placeholder="' . esc_attr__('Search', 'ukko-wp') . '" value="" name="s" title="' . esc_attr__('Search for:', 'ukko-wp') . '" /> 
</label>    
</form>';
...
if (!function_exists('cocobasic_register_menu')) {
    ...
    function cocobasic_register_menu() {
        register_nav_menu('custom_menu', __('Main Menu', 'ukko-wp'));
    }
...
if (!function_exists('cocobasic_wp_register_required_plugins')) {
    ...
    function cocobasic_wp_register_required_plugins() {
        ...
        $plugins = array(
            array(
                'name' => esc_html('CocoBasic - Ukko WP'),
            ...
            array(
                'name' => esc_html('CocoBasic - Ukko Elementor Widgets'),
...
if (!function_exists('cocobasic_wp_widgets_init')) {
    ...
    function cocobasic_wp_widgets_init() {
        register_sidebar(array(
            'name' => esc_html__('Footer Sidebar', 'ukko-wp'),
            'id' => 'footer-sidebar',
            'description' => esc_html__('Widgets in this area will be shown in footer on all pages and posts', 'ukko-wp'),
